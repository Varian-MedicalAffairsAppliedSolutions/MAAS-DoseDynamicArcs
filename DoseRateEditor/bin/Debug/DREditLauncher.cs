...
namespace VMS.TPS
{
  public class Script
  {
    ...
    public void Execute(ScriptContext context /*, System.Windows.Window window, ScriptEnvironment environment*/)
    {
        ...
        private string AppExePath([CallerFilePath] string pathHere = "")  //CallerFilePath only works for single file plugins (compiled on demand)
        {
            var workingDirectory = Path.GetDirectoryName(pathHere);
            return Path.Combine(workingDirectory, "DoseRateEditor.exe");
        }
    }
}
