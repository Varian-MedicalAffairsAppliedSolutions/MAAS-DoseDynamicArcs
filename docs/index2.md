...
Agreement and the provision the parties intend to modify or amend.<br><br>
    ...
    <iframe
      id="JotFormIFrame-251060598290155"
      title="Varian Limited Use Software License Agreement (AOS Virtual Cones)"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allow="geolocation; microphone; camera; fullscreen"
      src="https://form.jotform.com/251060598290155"
      frameborder="0"
    ...
    <script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-251060598290155']", "https://form.jotform.com/")</script>
